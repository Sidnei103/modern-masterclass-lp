    ...
    <div className="relative bg-hero-gradient overflow-hidden pb-0">
      ...
      <div className="container mx-auto px-4 pt-8 relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mt-8">
          <div className="inline-block bg-gradient-to-r from-primary via-primary-light to-primary p-[2px] rounded-full mb-6 hover:shadow-lg hover:shadow-primary/20 transition-shadow duration-300">
            <div className="bg-gradient-to-br from-secondary to-black px-6 py-2 rounded-full">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary-light to-primary font-semibold animate-pulse-soft">
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            ...
            <span className="text-xl md:text-2xl text-white font-medium">18/02 às 19h • 100% Online e Gratuito</span>
          </div>
        </div>
